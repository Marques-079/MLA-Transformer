...
class DataLoaderLite:
    def __init__(self, B, T):
        ...
        print(f"DataLoaderLite: loaded {self.tokens.size(0)} tokens")
...
if __name__ == '__main__':
    ...
    model = GPT(GPTConfig(vocab_size=50304, n_layers=12from dataclasses import dataclass
import torch 
import torch.nn as nn
from torch.nn import functional as F 
import math
...
if __name__ == '__main__':
    ...
    model = GPT(GPTConfig(vocab_size=50304, n_layers=12))
    ...
    for step in range(50):
        ...
        tokens_per_sec = (train_loader.B * train_loader.T * grad_accum_steps) / (end - start)
